...
export default defineConfig({
  title: "Badger Maths",
  description: "Precise Floating Point Maths",
  head: [['link', { rel: 'icon', href: '/badger-maths/images/badger3.svg' }]],
  base: '/badger-maths/',
  outDir: '../docs',
  lastUpdated: true,
  themeConfig: {
    siteTitle: 'Badger Maths',
    logo: '/images/badger3.svg',
    // https://vitepress.dev/reference/default-theme-config
    nav: [
      { text: 'Home', link: '/' },
      { text: 'Examples', link: '/add' }
    ],
    sidebar: [
      {
        text: 'Examples',
        items: [
          ...
          { text: 'multiply', link: '/multiply' },
          { text: 'divide', link: '/divide' },
          { text: 'clamp', link: '/clamp' },
        ]
      }
    ],
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/abw/badger-maths' },
    ],
    footer: {
      message: '<a href="https://badgerpower.com/" target="_blank" rel="noreferrer">Built by Badgers</a>',
      copyright: '©️ Andy Wardley 2022-2025'
    }
  }
})
